...
using SmxAuthSimple.API.Data;
using SmxAuthSimple.API.Data.Entities;
using SmxAuthSimple.API.Data.Interfaces;
using SmxAuthSimple.API.Data.Repository;
using SmxAuthSimple.API.Data.Seeder;
using SmxAuthSimple.API.Services;

namespace SmxAuthSimple.API.Extensions;
/// <summary>
...
public static class ServiceCollectionExtensions
{
    ...
    /// <param name="connectionString">Connection string for SQLite <example>"data source= SmxAuthSimple.db"</example></param>
