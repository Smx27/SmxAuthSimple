...
using SmxAuthSimple.API.Controllers.DTO.Exception;
using SmxAuthSimple.API.Data.Interfaces;

namespace SmxAuthSimple.API.Middleware;
    ...
    public async Task InvokeAsync(HttpContext context, IExceptionLogRepository logRepository)
    {
        ...
        catch (Exception e)
        {
            ...
            var response = _environment.IsDevelopment()
                ...
                : new ApiExceptionDto(context.Response.StatusCode, e.Message, "Internal Server Error \n Please Contact Admins");
